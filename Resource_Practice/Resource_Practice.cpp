// Resource_Practice.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_RESOURCEPRACTICE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_RESOURCEPRACTICE));
...
void FileOpenDialog(HWND hWnd)
{
    ...
    if(GetOpenFileName(&OFN))
    {
        ...
        MessageBox(hWnd, OFN.lpstrFile, _T("선택한 파일"), MB_OK);
    }
}
